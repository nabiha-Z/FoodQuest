...
<body>
   ...
   <h1 class="animate__animated animate__slideInDown">Feeling Hungry? </h1>
    <p class="animate__animated animate__fadeInUp">Why to fear when Food Quest is here!<br><br><a href="FoodOrderingSystemMenu.php"><span  class="animate__animated animate__zoomIn" style="animation-delay:1s;" id="Order-Button">Order it</span ></a>
	   ...
	   <form action="search.php#foodmenu" method="POST">
	        <input type="text" placeholder="Search for food/ Resturant" name="search" id="search"><a href="search.php#foodmenu"><i class="fa fa-search"></i></a>
	   </form>
...
<br></br>
<h1 class="title-tag" id="foodmenu">Popular Dishes</h1>
...
<div style=" padding:2px;"class="container-fluid text-center" >
<div class="row mx-auto my-auto">
		...
		echo '<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 ">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">'.$name. '<span class="add-to-cart-button"><a href="addincart.php?name='.$name.'& image='.$image.'& price='.$price.'& desc='.$description.' &resturant='.$resturant.'" style="color: white; text-decoration:none;" >Add to Cart</a></span></h4>
				
							
							<p class="description">'. $description. '</p>
							<p class="description">'. $resturant. '</p>
